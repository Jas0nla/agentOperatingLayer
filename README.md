...
- `skills/xhs-master-os/SKILL.md`: bounded-context and continuity OS for long-running Xiaohongshu systems
...
- a reusable Xiaohongshu operating-layer skill
...
- Keep bounded-context Xiaohongshu continuity in `skills/xhs-master-os/SKILL.md`
