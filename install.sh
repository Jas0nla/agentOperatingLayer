...
mkdir -p "$TARGET_ROOT/skills/xhs-master-os/agents"
mkdir -p "$TARGET_ROOT/skills/xhs-master-os/templates"
...
copy_shared "$SCRIPT_DIR/skills/xhs-master-os/SKILL.md" "$TARGET_ROOT/skills/xhs-master-os/SKILL.md"
copy_shared "$SCRIPT_DIR/skills/xhs-master-os/README.md" "$TARGET_ROOT/skills/xhs-master-os/README.md"
copy_shared "$SCRIPT_DIR/skills/xhs-master-os/agents/openai.yaml" "$TARGET_ROOT/skills/xhs-master-os/agents/openai.yaml"
copy_shared "$SCRIPT_DIR/skills/xhs-master-os/templates/board-registry-entry.template.md" "$TARGET_ROOT/skills/xhs-master-os/templates/board-registry-entry.template.md"
copy_shared "$SCRIPT_DIR/skills/xhs-master-os/templates/board-state-card.template.md" "$TARGET_ROOT/skills/xhs-master-os/templates/board-state-card.template.md"
copy_shared "$SCRIPT_DIR/skills/xhs-master-os/templates/handoff-package.template.md" "$TARGET_ROOT/skills/xhs-master-os/templates/handoff-package.template.md"
copy_shared "$SCRIPT_DIR/skills/xhs-master-os/templates/new-thread-starter.template.md" "$TARGET_ROOT/skills/xhs-master-os/templates/new-thread-starter.template.md"
copy_shared "$SCRIPT_DIR/skills/xhs-master-os/templates/working-set.template.md" "$TARGET_ROOT/skills/xhs-master-os/templates/working-set.template.md"
...
create_if_missing "$SCRIPT_DIR/memory/topics/xhs-master-os.template.md" "$TARGET_ROOT/memory/topics/xhs-master-os.md"
